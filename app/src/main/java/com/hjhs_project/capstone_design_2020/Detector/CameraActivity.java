...
public abstract class CameraActivity extends AppCompatActivity
  ...
  private static final com.hjhs_project.capstone_design_2020.Detector.env.Logger LOGGER = new com.hjhs_project.capstone_design_2020.Detector.env.Logger();
  ...
  //프라그먼트 가져오기
  private static Fragment fragment_intent;
  ...
  public void onPreviewFrame(final byte[] bytes, final Camera camera) {
    ...
    imageConverter =
        new Runnable() {
          @Override
          public void run() {
            com.hjhs_project.capstone_design_2020.Detector.env.ImageUtils.convertYUV420SPToARGB8888(bytes, previewWidth, previewHeight, rgbBytes);
          }
        };
    ...
    try {
      ...
      imageConverter =
          new Runnable() {
            @Override
            public void run() {
              com.hjhs_project.capstone_design_2020.Detector.env.ImageUtils.convertYUV420ToARGB8888(
                  yuvBytes[0],
                  yuvBytes[1],
                  yuvBytes[2],
                  previewWidth,
  ...
  protected void setFragment() {
    ...
    if (useCamera2API) {
      ...
      fragment_intent = fragment;
    }
    fragment_intent = fragment;       //전달할 fragment객체 getLayoutId는 프래그먼트 R.Layout.tfe~~~tracking이다.
  ...
  public static Fragment getFragment_intent(){
    return fragment_intent;
  }
}
